...
namespace Q6
{
    ...
    public class Employee : Person
    {
        ...
        public new void Accept()
        {
            ...
            Console.WriteLine("Select Department: 0 = HR, 1 = IT, 2 = Sales, 3 = Finance, 4 =Training ");
    ...
    public class WageEmp : Employee
    {
        ...
        public WageEmp(string name, bool gender, Date birth, string address, int hours, int rate, DepartmentType dept)
            : base(name, gender, birth, address, 0.0, "Wage", dept)
        {
            this.hours = hours;
            this.rate = rate;
        }
        ...
        public new void Accept()
        {
            ...
            Designation = "Wage"; // Ensures the designation is fixed to "Wage"
        }
        ...
        public override string ToString()
        {
            return base.ToString() + "\n" +
                   $"Hours Worked: {hours}\n" +
                   $"Rate per Hour: {rate:C}\n" +
                   $"Total Wage: {CalculateWage():C}";
        }
    }
